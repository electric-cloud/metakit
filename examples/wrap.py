...
dc = [C("one", "un", 1), C("two", "deux", 2), C("three", "trois", 3)]

dd = [{"a": "one", "b": "un", "c": 1}, {"a": "two", "b": "deux", "c": 2}, {"a": "three", "b": "trois", "c": 3}]

dt = [("one", "un", 1), ("two", "deux", 2), ("three", "trois", 3)]

pl = [metakit.property("S", "a"), metakit.property("S", "b"), metakit.property("I", "c")]
